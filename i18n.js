...
(function () {
  ...
  var I18N = {
    pt: {
      ...
      tabs_outputs: "SAÍDAS",
      tabs_help: "AJUDA",
      module_palletizing: "PALETIZAÇÃO",
      module_buffer: "BUFFER",
      module_compact: "TRF COMPACT",
      module_field: "CAMPO",
      module_buffer_title: "Buffer",
      module_buffer_desc: "Em breve: Módulo de análise de buffer.",
      module_compact_title: "TRF Compact",
      module_compact_desc: "Dimensionamento da célula de paletização TRF Compact.",
      module_field_title: "Campo",
      module_field_desc: "Em breve: Módulo de análise de campo.",
      compact_gripper_type: "Tipo de garra",
      compact_gripper_vacuum: "Vácuo (14 ciclos/min)",
      compact_gripper_clamp: "Clamp (12 ciclos/min)",
      compact_sku_name: "Nome do SKU",
      compact_production_rate: "Taxa de produção (cx/min)",
      compact_boxes_per_layer: "Caixas por camada",
      compact_picks_per_layer: "Capturas por camada",
      compact_layers_per_pallet: "Camadas por pallet",
      compact_transition_time: "Tempo transição pallet (s)",
      compact_kpi_capacity: "Capacidade",
      compact_kpi_boxes_cycle: "Caixas/ciclo",
      compact_kpi_occupancy: "Taxa de ocupação",
      compact_kpi_accum: "Limpa acúmulo?",
      compact_accum_ok: "Sim",
      compact_accum_fail: "Não",
      compact_global_config: "Configurações Globais",
      compact_line_1: "Linha 1",
      compact_line_2: "Linha 2",
      buf_input_params: "Parâmetros de Entrada",
      buf_infeed_rate: "Taxa de Entrada (Infeed)",
      buf_outfeed_rate: "Taxa de Saída (Outfeed)",
      buf_pallet_transition: "Tempo de Parada",
      buf_boxes_per_pallet: "Caixas por Pallet",
      buf_physical_dim: "Dimensões Físicas",
      buf_length: "Comprimento do Buffer",
      buf_width: "Largura do Buffer",
      buf_box_length: "Comprimento da Caixa",
      buf_box_width: "Largura da Caixa",
      buf_verdict_title: "Veredito da Engenharia",
      buf_verdict_waiting: "Preencha os parâmetros para ver o veredito técnico.",
      buf_tech_indicators: "Indicadores Técnicos",
      buf_max_phys_cap: "Capacidade Física Máxima",
      buf_stop_accum: "Acúmulo Dinâmico na Parada",
      buf_crit_occ: "Ocupação Crítica",
      buf_safety_margin: "Margem de Segurança (Tempo Pulmão)",
      buf_recovery_time: "Tempo de Recuperação",
      buf_sim_title: "Simulação do Acúmulo",
      buf_sim_btn: "Simular Troca",
      buf_reset_btn: "Zerar",
      buf_flow_direction: "Fluxo da Linha",
      buf_infeed_unit: "cpm (caixas/min)",
      buf_seconds_unit: "segundos",
      buf_units_unit: "unidades",
      buf_mm_unit: "mm",
      ...
      in_project_name: "Nome do Projeto",
      ...
      output_top_can_clear_accum: "Limpa acúmulo?",
      ...
      feasibility_matrix_title: "Taxa de Ocupação por Linha",
      ...
      insight_occ_global_critical_title: "Ocupação Global Crítica ({{value}})",
      insight_occ_global_critical_msg: "O robô excedeu a capacidade para o conjunto de linhas selecionado.",
      insight_occ_global_warn_title: "Atenção à Ocupação ({{value}})",
      insight_occ_global_warn_msg: "A soma das linhas está próxima ao limite operacional do robô.",
      insight_net_removal_critical_title: "Linha {{n}}: Remoção Negativa",
      insight_net_removal_critical_msg: "A taxa de entrada é maior que a capacidade de extração nesta linha.",
      insight_slip_accum_warn_title: "Linha {{n}}: Acúmulo de Slip Sheet",
      insight_slip_accum_warn_msg: "O acúmulo gerado pelo Slip Sheet não é limpo antes da próxima aplicação.",

      welcome_title: "Cycle Timer",
      welcome_subtitle: "Análise de capacidade de paletização",
      welcome_continue: "Continuar de onde parei",
      welcome_load: "Carregar cenário (JSON)",
      welcome_new: "Começar do zero"
    },
    en: {
      ...
      tabs_help: "HELP",
      module_palletizing: "PALLETIZING",
      module_buffer: "BUFFER",
      module_compact: "TRF COMPACT",
      module_field: "FIELD",
      module_buffer_title: "Buffer",
      module_buffer_desc: "Coming soon: Buffer analysis module.",
      module_compact_title: "TRF Compact",
      module_compact_desc: "TRF Compact palletizing cell sizing.",
      module_field_title: "Field",
      module_field_desc: "Coming soon: Field analysis module.",
      compact_gripper_type: "Gripper type",
      compact_gripper_vacuum: "Vacuum (14 cycles/min)",
      compact_gripper_clamp: "Clamp (12 cycles/min)",
      compact_sku_name: "SKU name",
      compact_production_rate: "Production rate (boxes/min)",
      compact_boxes_per_layer: "Boxes per layer",
      compact_picks_per_layer: "Picks per layer",
      compact_layers_per_pallet: "Layers per pallet",
      compact_transition_time: "Pallet transition time (s)",
      compact_kpi_capacity: "Capacity",
      compact_kpi_boxes_cycle: "Boxes/cycle",
      compact_kpi_occupancy: "Occupancy rate",
      compact_kpi_accum: "Clears accum.?",
      compact_accum_ok: "Yes",
      compact_accum_fail: "No",
      compact_global_config: "Global Settings",
      compact_line_1: "Line 1",
      compact_line_2: "Line 2",
      buf_input_params: "Input Parameters",
      buf_infeed_rate: "Infeed Rate",
      buf_outfeed_rate: "Outfeed Rate",
      buf_pallet_transition: "Pallet Exchange Time",
      buf_boxes_per_pallet: "Boxes per Pallet",
      buf_physical_dim: "Physical Dimensions",
      buf_length: "Buffer Length",
      buf_width: "Buffer Width",
      buf_box_length: "Box Length",
      buf_box_width: "Box Width",
      buf_verdict_title: "Engineering Verdict",
      buf_verdict_waiting: "Fill parameters to view the technical verdict.",
      buf_tech_indicators: "Technical Indicators",
      buf_max_phys_cap: "Max Physical Capacity",
      buf_stop_accum: "Stop Accumulation",
      buf_crit_occ: "Critical Occupancy",
      buf_safety_margin: "Safety Margin (Buffer Time)",
      buf_recovery_time: "Recovery Time",
      buf_sim_title: "Accumulation Simulation",
      buf_sim_btn: "Simulate Exchange",
      buf_reset_btn: "Reset",
      buf_flow_direction: "Line Flow",
      buf_infeed_unit: "cpm (boxes/min)",
      buf_seconds_unit: "seconds",
      buf_units_unit: "units",
      buf_mm_unit: "mm",
      ...
      output_top_can_clear_accum: "Clears accum.?",
      ...
      feasibility_matrix_title: "Line Occupancy Rate",
      ...
      insight_occ_global_critical_title: "Critical Global Occupancy ({{value}})",
      insight_occ_global_critical_msg: "The robot has exceeded the capacity for the selected set of lines.",
      insight_occ_global_warn_title: "Occupancy Warning ({{value}})",
      insight_occ_global_warn_msg: "The sum of the lines is close to the robot's operational limit.",
      insight_net_removal_critical_title: "Line {{n}}: Negative Removal",
      insight_net_removal_critical_msg: "The input rate is higher than the extraction capacity on this line.",
      insight_slip_accum_warn_title: "Line {{n}}: Slip Sheet Accumulation",
      insight_slip_accum_warn_msg: "The accumulation generated by the Slip Sheet is not cleared before the next application.",

      welcome_title: "Cycle Timer",
      welcome_subtitle: "Palletizing capacity analysis",
      welcome_continue: "Continue where I left off",
      welcome_load: "Load scenario (JSON)",
      welcome_new: "Start fresh"
    }
  };
